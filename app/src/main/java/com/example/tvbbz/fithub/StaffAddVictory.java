...
public class StaffAddVictory extends AppCompatActivity {
    ...
    private Button addnewvictory, selectimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_add_victory);
        getSupportActionBar().setTitle("Victory");


        mStorageRef = FirebaseStorage.getInstance().getReference("victory");
        ...
        posttitle = (EditText) findViewById(R.id.victorytitle);
        describe = (EditText) findViewById(R.id.descvictory);
        selectimage = (Button) findViewById(R.id.uploadimage);
        addnewvictory = (Button) findViewById(R.id.newvictorybutton);
        newuploadprogress = (ProgressBar) findViewById(R.id.newvictoryprogressbar);
        ...
        addnewvictory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                uploadfile();
            }
            ...
            fileref.putFile(imageuri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(StaffAddVictory.this, "Upload Sucessful",Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(StaffAddVictory.this,e.getMessage(),Toast.LENGTH_SHORT).show();
